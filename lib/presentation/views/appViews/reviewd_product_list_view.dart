...
import 'package:amazon_sale_app/presentation/elements/reviewed_product_list_tile.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ReviewedProductListView extends StatelessWidget {
        ...
        Expanded(
          child: StreamProvider.value(
            value: _productServices
                .streamReviewedProducts(user.getUserDetails.uid),
              ...
              return context.watch<List<ProductModel>>() == null
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        return ReviewedProductListTile(
